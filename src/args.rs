...
pub enum Args {
	...
	#[structopt(name="encrypt", about="Encrypt document and receive document key ID and IPFS hash")]
	Encrypt {
		#[structopt(help="Pass a document file path you want to encrypt", required=true)]
		file: PathBuf,
	},
